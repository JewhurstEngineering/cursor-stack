...
Download the latest signed and notarized build from [GitHub Releases](https://github.com/JewhurstEngineering/cursor-stack/releases/latest/download/CursorStack-1.0.7.zip).
